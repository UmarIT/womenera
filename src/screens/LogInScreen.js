      ...
      {({
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.text_header_One}>Login to your account</Text>
          </View>
          <Animatable.View style={styles.footer} animation="fadeInUpBig">
            ...
            {/* <TouchableOpacity
              ...
              style={[
                styles.signIn,
                {borderColor: '#be7df0', borderWidth: 1, marginTop: 15},
              ]}>
            ...
            <Pressable onPress={() => navigation.navigate('SignUp')}>
              <View
                ...
                <Text style={styles.createAcc}> Register Now</Text>
              </View>
            </Pressable>
          </Animatable.View>
        </View>
